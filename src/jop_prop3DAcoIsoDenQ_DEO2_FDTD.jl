...
function JopProp3DAcoIsoDenQ_DEO2_FDTD_f!(d::AbstractArray, m::AbstractArray; kwargs...)
    d .= 0
...
function srcillum!(γ, A::T, m::AbstractArray) where {D,R,J<:Jet{D,R,typeof(JopProp3DAcoIsoDenQ_DEO2_FDTD_f!)},T<:Jop{J}}
    s = state(A)
