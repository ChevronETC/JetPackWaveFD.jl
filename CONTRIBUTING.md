# JetPackWaveFD.jl contributor guidelines

## Issue reporting
If you have found a bug in JetPackWaveFD.jl or have any suggestions for changes to
JetPackWaveFD.jl functionality, please consider filing an issue using the GitHub
...
making changes to JetPackWaveFD.jl.
...
git:
  1. fork the JetPackWaveFD.jl repository
  ...
  4. run `]test JetPackWaveFD` in the `test` folder
